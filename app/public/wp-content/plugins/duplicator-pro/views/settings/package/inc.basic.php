        ...
        if ($available) {
            ...
            if ($is_custom) {
                DUP_PRO_U::esc_html_e(
                    ...
                    'Please check is there some typo mistake or mysqldump program exists on that location. Also you can leave custom path empty to force automatic settings.'
                );
                echo ' ';
                    ...
                    <?php if (!$is_shellexec_on) :
                        ...
                        <div class="dup-feature-notfound">
                            ...
                            <code class="display-block margin-bottom-1">
                                <?php foreach (['escapeshellarg', 'escapeshellcmd', 'extension_loaded', 'exec', 'popen', 'pclose', 'shell_exec'] as $func) { ?>                                   
                                    <?php
                        ...
                        <div class="dup-group-option-wrapper">
                            ...
                            foreach ($mysqldumpOptions as $key => $option) {
                                ?>
                                <div class="dup-group-option-item"><input type="checkbox" name="<?php echo $option->getInputName(); ?>" id="<?php echo $option->getInputName(); ?>"
