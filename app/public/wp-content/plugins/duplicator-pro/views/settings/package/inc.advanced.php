...
<form id="dup-settings-form" action="<?php echo Duplicator\Core\Controllers\ControllersManager::getCurrentLink(); ?>" method="post" data-parsley-validate>
        ...
        <tr valign="top">
            ...
            <td>
                <input 
                    ...
                    data-parsley-min="10" data-parsley-type="number" class="narrow-input" 
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <input 
                    ...
                    value="<?php echo $sglobal->basic_auth_password; ?>" 
                >
    ...
    <p class="submit dpro-save-submit">
        <input type="submit" name="submit" id="submit" class="button-primary" value="<?php DUP_PRO_U::esc_attr_e('Save Advanced Package Settings') ?>" style="display: inline-block;" />
    </p>
</form>
