...
class ServicesRecovery extends AbstractAjaxService
{
    ...
    {
        AjaxWrapper::json(array(__CLASS__, 'setRecoveryCallback'), 'duplicator_pro_set_recovery', $_POST['nonce'], 'export');
    }
    ...
    {
        AjaxWrapper::json(array(__CLASS__, 'getWidgetCallback'), 'duplicator_pro_get_recovery_widget', $_POST['nonce'], 'export');
    }
    ...
    {
        AjaxWrapper::json(array(__CLASS__, 'resetRecoveryCallback'), 'duplicator_pro_reset_recovery', $_POST['nonce'], 'export');
    }
}
