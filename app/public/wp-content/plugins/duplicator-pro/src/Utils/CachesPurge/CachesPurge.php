...
class CachesPurge
{
    ...
    protected static function getPurgePlugins()
    {
        ...
        $items[] = new CacheItem(
            ...
            function () {
                return class_exists('WPN_Helper') && is_callable('WPN_Helper', 'set_forms_maintenance_mode');
            },
        ...
        $items[] = new CacheItem(
            ...
            function () {
                if (method_exists('\\WpeCommon', 'purge_memcached')) {
                    \WpeCommon::purge_memcached(); // @phpstan-ignore-line
                }
                if (method_exists('\\WpeCommon', 'purge_varnish_cache')) {
                    \WpeCommon::purge_varnish_cache(); // @phpstan-ignore-line
                }
            }
        );
        $items[] = new CacheItem(
