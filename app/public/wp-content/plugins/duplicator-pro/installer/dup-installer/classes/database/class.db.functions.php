...
class DUPX_DB_Functions
{
    ...
    /** @var array current data connection */
    private $dataConnection = null;
    /** @var array list of supported engine types */
    private $engineData = null;
    /** @var array supported charset and collation data */
    private $charsetData = null;
    /** @var string default charset in dwtabase connection */
    ...
    /**
     *
     * @param false|string $tableNamePatten
     *
     * @return array
     */
