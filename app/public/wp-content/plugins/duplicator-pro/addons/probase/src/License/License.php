...
final class License extends AbstractLicense
{
    ...
    public static function getLicenseData($forceRefresh = false)
    {
        ...
        return ($license_data == null ? false : $license_data);
    }
    ...
    {
        return 'https://snapcreek.com/dashboard/';
    }
    ...
    public static function getNoActivationLeftMessage()
    {
        if (self::isUnlimited()) {
            ...
            return __(
                'Use the link above to login to your snapcreek.com dashboard to manage your licenses or upgrade to a higher license.',
                'duplicator-pro'
            );
        }
    }
