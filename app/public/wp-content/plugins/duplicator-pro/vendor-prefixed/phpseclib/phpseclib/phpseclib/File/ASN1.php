...
class ASN1
{
        ...
        switch ($class) {
            ...
            case self::CLASS_CONTEXT_SPECIFIC:
                ...
                while ($remainingLength > 0) {
                    ...
                    if (\substr($content, $length, 2) == "\x00\x00") {
                        $length += 2;
                        $start += $length;
                        $newcontent[] = $temp;
                        break;
        ...
        switch ($tag) {
            ...
            case self::TYPE_OCTET_STRING:
                if (!$constructed) {
                    ...
                    $current['content'] = '';
                    $length = 0;
                    while (\substr($content, 0, 2) != "\x00\x00") {
            ...
            case self::TYPE_SET:
                ...
                while (\strlen($content)) {
                    ...
                    if (!isset($current['headerlength']) && \substr($content, 0, 2) == "\x00\x00") {
                        $length = $offset + 2;
                        // +2 for the EOC
                        break 2;
                    }
    ...
    function _decodeTime($content, $tag)
    {
        ...
        $pattern = $tag == self::TYPE_UTC_TIME ? '#(..)(..)(..)(..)(..)(..)(.*)#' : '#(....)(..)(..)(..)(..)(..).*([Z+-].*)$#';
