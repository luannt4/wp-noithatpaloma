...
class DUP_PRO_Package_Importer
{
     ...
     *
     * @return string ENUM: PATH_MODE_CLASSIC,PATH_MODE_BACKUP, PATH_MODE_HOME, PATH_MODE_BRIDGE, PATH_MODE_NONE
     */
    protected function getPathMode()
    {
        ...
        if (!DUPLICATOR_FORCE_IMPORT_BRIDGE_MODE) {
        ...
        switch ($this->getPathMode()) {
            ...
            case self::PATH_MODE_BRIDGE:
                ...
                $data               = [
                    ...
                    'brchk'          => BootstrapUtils::getBridgeHash()
                ];
