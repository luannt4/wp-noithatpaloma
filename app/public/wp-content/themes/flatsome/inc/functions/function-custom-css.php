...
.container-width, .full-width .ubermenu-nav, .container, .row{max-width: <?php echo $site_width ; ?>px}
.row.row-collapse{max-width: <?php echo $site_width - 30; ?>px}
...
.header:not(.transparent) .header-nav-main.nav > li > a {
    ...
    <?php if(get_theme_mod('nav_uppercase')){ ?>
